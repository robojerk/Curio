...
**[Download v0.1.7](https://github.com/robojerk/Curio/releases/tag/v0.1.7)** — pre-built Flatpak bundle (x86_64).
...
```bash
flatpak install --system --bundle io.github.curio.Curio-x86_64.flatpak
```
